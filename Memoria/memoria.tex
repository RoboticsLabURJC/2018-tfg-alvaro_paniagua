...
\begin{itemize}
	\item Registra los tres componentes constituyentes del robot en \emph{AFRAME}. Para la simulación del robot en el 
...
con atributos y el motor \emph{AFRAME} se encarga de su funcionamiento tridimensional.\\
...
mediciones. Las físicas permiten hacer uso del motor de físicas en el paquete \emph{aframe-physics}
...
\begin{figure}[h]
	...
	\caption{Etiquetas utilizadas para la simulación del robot en el entorno \emph{AFRAME}.}
...
solo se repita 1 vez en ambos ejes entonces \emph{AFRAME} estira la textura hasta ajustarla con al tamaño del 
plano.
...
El robot consta de varios sensores y actuadores, simulados por \emph{AFRAME}.Los drivers permiten a código
...
manejando la representación web del robot en \emph{AFRAME}.\\
...
AFRAME y se crean variables internas para guardar los datos y servirlos mediante una instrucción simple.\\
...
\begin{itemize}
	...
	de coordenadas tomado en AFRAME donde Y es la altura). Esta velocidad no es utilizada en la implementación
	actual del robot. En
...
Cabe comentar el sistema de coordenadas del que hace uso \emph{AFRAME} para entender 
los datos que se obtienen en estas funciones del HAL API. La Figura ~\ref{fig:aframe-axis} muestra los ejes utilizados.
