...
En este apartado se explican cómo se inician los sensores, las funciones de acceso a los datos de
...
Como resumen, el usuario normalmente usará los métodos \emph{getDistance, getDistances y readIR} para
...
\begin{figure}[h]
	\centering
	\includegraphics[width=15cm, height=8cm]{img/interfaz-js.PNG}
